...
{ 
	...
	wp_register_style( 'flexslider', get_template_directory_uri() . '/inc/assets/css/jquery.flipster.min.css' );
...
function ti_custom_javascript() {
    wp_enqueue_script( 'example-script', get_template_directory_uri() . '/js/jquery.flipster.min.js');
    }
add_action('wp_enqueue_scripts', 'ti_custom_javascript');

function jq_custom_javascript() {
    wp_enqueue_script( 'example-script2', get_template_directory_uri() . '/js/jquery.min.js');
    }
add_action('wp_enqueue_scripts', 'jq_custom_javascript');
...
function my_acf_init_block_types()
{
    ...
    if (function_exists('acf_register_block_type')) {
        ...
        acf_register_block_type(array(
            ...
            'description'       => __('Main Header'),
            'render_template'   => 'template-parts/blocks/main-header.php',
            'category'          => 'formatting',
            'icon'              => 'admin-comments',
            'keywords'          => array('Standard Content', 'quote'),
        ));
        ...
        acf_register_block_type(array(
            'name'              => 'main_banner version 2',
            'title'             => __('Main Banner version 2'),
            'description'       => __('Main Banner version 2'),
            'render_template'   => 'template-parts/blocks/main_banner_v2.php',
            'category'          => 'media',
            'icon'              => 'admin-comments',
            // 'keywords'          => array('Title Content With 4 Column Grid', 'quote'), 			
        ));
        acf_register_block_type(array(
            'name'              => 'accordion-main',
            'title'             => __('Accordion Main'),
            'description'       => __('Accordion Main'),
            'render_template'   => 'template-parts/blocks/accordion-main.php',
            'category'          => 'media',
            'icon'              => 'admin-comments',		
        ));
        acf_register_block_type(array(
        ...
        acf_register_block_type(array(
            'name'              => 'key_date_block',
            'title'             => __('Key Dates'),
            'description'       => __('ey Dates'),
            'render_template'   => 'template-parts/blocks/dates_key.php',
            'category'          => 'formatting',
            'icon'              => 'admin-comments',
        ));
        acf_register_block_type(array(
        ...
        acf_register_block_type(array(
            'name'              => 'text_left_with_1images',
            'title'             => __('Text Left With 1 Images'),
            'description'       => __('Text Left With 1 Images'),
            'render_template'   => 'template-parts/blocks/text_left_with_1images.php',
            'category'          => 'formatting',
            'icon'              => 'admin-comments',
        ));
        acf_register_block_type(array(
            'name'              => 'text_right_with_1images',
            'title'             => __('Text Right With 1 Images'),
            'description'       => __('Text Right With 1 Images'),
            'render_template'   => 'template-parts/blocks/text_right_with_1image.php',
            'category'          => 'formatting',
            'icon'              => 'admin-comments',
        ));
        acf_register_block_type(array(
        ...
        acf_register_block_type(array(
            'name'              => 'speakers_list_version2',
            'title'             => __('Speakers List Version 2'),
            'description'       => __('Speakers List Version 2'),
            'render_template'   => 'template-parts/blocks/speakers_list_version2.php',
            'category'          => 'formatting',
            'icon'              => 'admin-comments',
        ));
        acf_register_block_type(array(
        ...
        acf_register_block_type(array(
            'name'              => 'companies_list',
            'title'             => __('Company list 4x in a row'),
            'description'       => __('Company list 4x in a row'),
            'render_template'   => 'template-parts/blocks/companies_list.php',
            'category'          => 'formatting',
            'icon'              => 'admin-comments',
        ));
		acf_register_block_type(array(
        ...
        acf_register_block_type(array(
            'name'              => 'video_header',
            'title'             => __('video_header'),
            'description'       => __('video_header'),
            'render_template'   => 'template-parts/blocks/cover-header.php',
			'category'          => 'media',
            'icon'              => 'admin-comments',
        ));
        acf_register_block_type(array(
            'name'              => 'hero_text_block_001',
            'title'             => __('Hero text'),
            'description'       => __('Hero text'),
            'render_template'   => 'template-parts/blocks/hero_text_block_001.php',
			'category'          => 'media',
            'icon'              => 'admin-comments',
        ));
        acf_register_block_type(array(
            'name'              => 'hero_text_block_with_1_image',
            'title'             => __('Hero text with 1 image'),
            'description'       => __('Hero text with 1 image'),
            'render_template'   => 'template-parts/blocks/hero_text_block_with_1_image.php',
			'category'          => 'media',
            'icon'              => 'admin-comments',
        ));
        acf_register_block_type(array(
            'name'              => 'hero_text_block_with_2_image',
            'title'             => __('Hero text with 2 image'),
            'description'       => __('Hero text with 2 image'),
            'render_template'   => 'template-parts/blocks/hero_text_block_with_2_image.php',
			'category'          => 'media',
            'icon'              => 'admin-comments',
        ));
        acf_register_block_type(array(
            'name'              => 'text_block_with_bg_image',
            'title'             => __('Text left with bg image'),
            'description'       => __('Text left with bg image'),
            'render_template'   => 'template-parts/blocks/text_block_with_bg_image.php',
			'category'          => 'media',
            'icon'              => 'admin-comments',
        ));
        acf_register_block_type(array(
            'name'              => 'text_block_with_bg_image_new',
            'title'             => __('Text left with bg image 2'),
            'description'       => __('Text left with bg image 2'),
            'render_template'   => 'template-parts/blocks/text_block_with_bg_image2.php',
			'category'          => 'media',
            'icon'              => 'admin-comments',
        ));
        acf_register_block_type(array(
            'name'              => 'image_list',
            'title'             => __('image list'),
            'description'       => __('image_list'),
            'render_template'   => 'template-parts/blocks/image_list.php',
			'category'          => 'media',
            'icon'              => 'admin-comments',
        ));
        acf_register_block_type(array(
            'name'              => 'Sldier with motion',
            'title'             => __('Motion Slider'),
            'description'       => __('Motion Slider'),
            'render_template'   => 'template-parts/blocks/slider-version-two.php',
			'category'          => 'media',
            'icon'              => 'slides',
        ));
        acf_register_block_type(array(
        ...
        acf_register_block_type(array(
            'name'              => 'text_block_with_bg_image version 3',
            'title'             => __('Text left with bg image version 3'),
            'description'       => __('Text left with bg image'),
            'render_template'   => 'template-parts/blocks/text_block_with_bg_image3.php',
			'category'          => 'media',
            'icon'              => 'dashicons-images-alt',
        ));
        acf_register_block_type(array(
            'name'              => 'horizontal-card-style-2',
            'title'             => __('Horizontal Card style 2'),
            'description'       => __('Horizontal Card style 2'),
            'render_template'   => 'template-parts/blocks/horizontal-card-style-2.php',
			'category'          => 'media',
            'icon'              => 'dashicons-index-card',
        ));
        acf_register_block_type(array(
            'name'              => 'button-theme-style',
            'title'             => __('button theme style'),
            'description'       => __('button theme style'),
