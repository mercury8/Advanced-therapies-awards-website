...
<div id="<?php echo esc_attr($id); ?>" class="<?php echo esc_attr($className); ?> <?php if($enable_background == 1): ?>enable_background<?php endif; ?> <?php if($height == 1): ?>enable_height<?php endif; ?> <?php if($reduce_space == 1): ?>reduce_space<?php endif; ?>">    
    <div class="text_left_with_1images__inner" <?php if($desktop_pattern_image || $mobile_pattern_image ): ?>style="background-image: url('<?php echo $desktop_pattern_image; ?>')<?php if( $mobile_pattern_image ): ?>, url('<?php echo $mobile_pattern_image; ?>')<?php endif; ?>;"<?php endif; ?>>
        <div class="container-fluid">
            <div class="text_left_with_1images__wrapper">
                <div class="text_left_with_1images__left">
                    <div class="text_left_with_1images__left__inner">
                ...
                <div class="text_left_with_1images__right">                    
