...
<div id="<?php echo esc_attr($id); ?>" class="<?php echo esc_attr($className); ?>">
    <div class="main_bannerv2__inner d-flex align-items-center" style=" background-color: <?php echo $background_color; ?>; background-image: url('<?php echo $desktop_pattern_image; ?>'), url('<?php echo $mobile_pattern_image; ?>');">
        <div class="container">
            <div class="main_banner__container d-flex align-items-center">
                ...
                <div class="main_banner__right">
                    <div class="main_banner__images d-flex align-items-center">
                        <div class="image1v image"><img src="<?php echo $image_1['url']; ?>" alt="<?php echo $image_1['alt']; ?>" /></div>
                        <div class="image2v image"><img src="<?php echo $image_2['url']; ?>" alt="<?php echo $image_2['alt']; ?>" /></div>
                        <div class="image3v image"><img src="<?php echo $image_3['url']; ?>" alt="<?php echo $image_3['alt']; ?>" /></div>
                    </div>                    
                </div>
            </div>
        </div>
