...
/**
 * Text Right With 3 Images Text Block.
 *
...
$id = 'text_right_with_3images-' . $block['id'];
if( !empty($block['anchor']) ) {
    $id = $block['anchor'];
}

// Create class attribute allowing for custom "className" and "align" values.
$className = 'text_right_with_3images';
...
<div id="<?php echo esc_attr($id); ?>" class="<?php echo esc_attr($className); ?> <?php if($enable_background == 1): ?>enable_background<?php endif; ?> <?php if($height == 1): ?>enable_height<?php endif; ?> <?php if($reduce_space == 1): ?>reduce_space<?php endif; ?>">    
    <div class="text_right_with_1images__inner" <?php if($desktop_pattern_image || $mobile_pattern_image ): ?>style="background-image: url('<?php echo $desktop_pattern_image; ?>')<?php if( $mobile_pattern_image ): ?>, url('<?php echo $mobile_pattern_image; ?>')<?php endif; ?>;"<?php endif; ?>>
        <div class="container-fluid">
            <div class="text_right_with_1images__wrapper">
                <div class="text_right_with_1images__left">                    
                    <?php if( $image_1 ): ?><div class="image_1 image_common"><img src="<?php echo $image_1['url']; ?>" alt="<?php echo $image_1['alt']; ?>" /></div><?php endif; ?>
                </div>
                <div class="text_right_with_1images__right">
                    <div class="text_right_with_1images__right__inner">
